...
const WeatherWidget = ({ location = "---", temperature = "---", conditions = "Sunny", isEmpty = false }) => {
  ...
  const weatherClass = `${styles.weatherWidget} ${conditionClassMap[conditions as keyof typeof conditionClassMap] || styles.weatherBGSunny}`;
